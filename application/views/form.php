...
<html lang="en">
  ...
  <body>
    ...
    <!-- Content here -->
        <div class="text-center"><img src="https://shinemmg.com/wp-content/uploads/2020/04/ShineMMG_LOGO.png" width="50%"></div>
            ...
            <form method="POST" action="<?=base_url()?>/IntakeForm/submit">
                ...
                <div class="section-handler">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-lg" id="date-of-birth" required placeholder="" name="ii_medicare">
                        </div>
                    </div>
                    <div class="form-group row">
